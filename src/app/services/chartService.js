angular.module('app')
    .factory('chartService', function () {
        ...
        function multiBarHorizontalChartOptions(selItem) {
            console.log("multiBarHorizontalChartOptions: " + selItem.sensorName);
            return {
                chart: {
        ...
        function multiBarHorizontalChartData(selItem) {
            console.log("multiBarHorizontalChartData: " + selItem.multiBarData);
            return selItem.multiBarData;
        }

        function multiBarHorizontalChartData2() {
            return [
                {
                    "key": "Minimum",
                    "color": "#1f77b4",
        ...
        function discreteBarChartData(selItem) {

            return [
                {
                    key: "Cumulative Return",
                    values: selItem.values,
                }
            ];
        }
